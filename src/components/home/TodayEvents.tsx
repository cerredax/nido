...
export function TodayEvents({ events, kids }: TodayEventsProps) {
  return (
    <CardSection label="Hoy">
      <Card padded={false}>
        {events.length === 0 ? (
          <EmptyState emoji="🗓️" title="Sin eventos hoy" description="Disfruta del día libre" />
        ) : (
